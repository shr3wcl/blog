            ...
            <div className="max-w-5xl px-4 mx-auto mt-10 sm:px-6 lg:px-0">
                ...
                <div className={"grid grid-cols-1 gap-4 sm:grid-cols-2"}>
                    {show_posts.map((post:Post) => (
                        <div className="card dark:bg-[#111827] border-[1px] border-gray-300 hover:border-blue-400 dark:hover:border-blue-400 dark:border-gray-700 dark:bg-gray-800 w-full max-h-48 lg:h-36" key={post.id}>
